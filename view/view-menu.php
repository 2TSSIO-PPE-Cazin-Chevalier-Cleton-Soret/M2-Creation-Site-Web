    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <?php if(isset($_SESSION['id'])) {
                if($type == "parent") {
                    echo "<li class=\"nav-item\"><a class='nav-link' href=\"tableau-de-bord.php\"><i class=\"fas fa-user-circle text-primary\"></i>Tableau de bord <span class=\"badge badge-primary\">Parent</span></a></li>";
                }
                if($type == "assistante") {
                    echo "<li class=\"nav-item\"><a class='nav-link' href=\"tableau-de-bord.php\"><i class=\"fas fa-user-circle text-primary\"></i>Tableau de bord <span class=\"badge badge-primary\">Assistante</span></a></li>";
                }
            } ?>
            <?php if(!isset($_SESSION['id'])) {
