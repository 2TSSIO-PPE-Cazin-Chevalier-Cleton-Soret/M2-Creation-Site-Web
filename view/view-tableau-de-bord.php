<div class="main">
    <div class="section">
        <div class="section__title">
            <h1>Bienvenue sur votre tableau de bord <span style="color: #2980b9;"><?= $_SESSION['pseudo']; ?></span></h1>
                    ...
                    if(isset($_POST)) {
                        if (isset($_POST['pseudo'])
                            ...
                            if ($req->fetchColumn() != 0) {}
                                ...
                                $type = $_POST['type'];
                                $req = $bdd->prepare('UPDATE membres(pseudo, mdp, nom, prenom, email, nbrEnfant, type) VALUES(:pseudo, :mdp, :nom, :prenom, :email, :nbrEnfant, :type) WHERE pseudo = :pseudo');
                                $req->execute(array(
                                    'pseudo' => $pseudo,
